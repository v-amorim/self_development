...
function doSkip()
	...
	mp.command(
		"no-osd af add @skiptosilence:lavfi=[silencedetect=noise=" .. opts.quietness .. "dB:d=" .. opts.duration .. "]"
	)
	mp.command(
		"no-osd vf add @skiptosilence-blackout:lavfi=" .. "[nullsink,color=c=black:s=" .. width .. "x" .. height .. "]"
	)
...
mp.add_key_binding("F9", "skip-to-silence", doSkip)
