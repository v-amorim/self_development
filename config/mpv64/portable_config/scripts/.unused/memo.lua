...
function path_info(full_path)
	...
	local display_path, effective_path, effective_protocol, is_remote, file_options =
		resolve(nil, full_path, nil, false)
...
function write_history(display)
	...
	if
		effective_protocol == "bd"
		or effective_protocol == "br"
		or effective_protocol == "bluray"
		or effective_protocol == "bdnav"
		or effective_protocol == "bluraynav"
	then
